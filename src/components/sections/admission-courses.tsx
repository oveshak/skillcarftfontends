...
const coursesData: CourseCardProps[] = [
  {
    ...
    href: "/programs/10447/varsity-a-unit-admission-course-2025/",
  },
  {
    ...
    href: "/programs/10448/varsity-b-unit-admission-course-2025/",
  },
  {
    ...
    href: "/programs/10449/varsity-c-unit-admission-course-2025/",
  },
];
  ...
  <Link href={href} className="block group">
    <div className="bg-card rounded-xl border border-border-subtle overflow-hidden transition-all duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-1">
      ...
      <div className="p-4 md:p-5">
        ...
        <p className="text-sm text-text-secondary pt-5">{instructors}</p>
